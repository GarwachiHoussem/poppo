...
@Component({
  selector: 'app-anchor-portuguese',
  standalone: true,
  imports: [],
  templateUrl: './anchor-portuguese.component.html',
  styleUrl: './anchor-portuguese.component.css'
})
export class AnchorPortugueseComponent {
